// t = 'fsgsfg '.repeat(300) + ' ' + 'fsgsfg '.repeat(299);
// t = ('fsgsfg '.repeat(299)).repeat(2);
...
export const countSentences: TCountSentences = (str) =>
	...
	splitStringToSentences(str).length;
...
export const caseConvertor: TCaseConvertor = (str, choosedCase) => {
	...
	if (
		...
		switch (choosedCase) {
			...
			case 'sentence': {
				return splitStringToSentences(str)
